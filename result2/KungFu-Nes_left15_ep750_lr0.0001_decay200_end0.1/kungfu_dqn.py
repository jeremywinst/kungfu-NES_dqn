...
dir = './result2/{}_{}_ep{}_lr{}_decay{}_end{}'.format(GAME_NAME, TRIAL_NUMBER, opt.episode, LR, EPS_DECAY, EPS_END)
...
e = [epsilon_by_epsiode(i) for i in range(opt.episode)]
...
def deploy(n_episodes):
    ...
    print('Episode {}\tAverage Score: {:.2f}'.format(n_episodes, np.mean(scores_window, dtype=np.int32)))
